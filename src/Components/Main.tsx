  ...
  return (
    <div className='Main'>
      <Box w={{ xl: '1130px', lg: '1130px', md: '1130px', sm: '750px' }} h={{ xl: '480px', lg: '480px', md: '100%', sm: '100%' }} margin={'150px auto'} display={'flex'} flexDirection={'column'} gap={'100px'} textAlign={'center'}>
        ...
        <Box w={'100%'} height={'100%'} position={'relative'} left={{ xl: '200px', lg: '200px', md: '200px', sm: '0px' }} display={'flex'} gap={'40px'} margin={{ xl: '0px', lg: '0px', md: '0px auto', sm: '0px auto' }}>
          ...
          <Stack direction={'column'} w={'fit-content'} color={'white'} gap={'30px'} alignItems={{ xl: 'baseline', lg: 'baseline', md: 'flex-start', sm: 'flex-start' }}>
      ...
      <Box w={{ xl: '1730px', lg: '1730px', md: '1000px' }} height={'715px'} display={'flex'} flexDirection={'column'} color={'white'} position={'relative'} left={{ xl: '200px', lg: '200px', md: '200px', sm: '0px' }} marginBottom={'150px'}>
        ...
        <Box display={'grid'} w={{ xl: '100%', lg: '100%', md: '880px', sm: '100%' }} gridTemplateColumns={{ xl: 'repeat(4, 1fr)', lg: 'repeat(4, 1fr)', md: 'repeat(2, 1fr)', sm: 'repeat(2, 1fr)' }} h={'550px !important'} >
          ...
          <Flex className='bg3' display={{ xl: 'flex', lg: 'flex', md: 'none', sm: 'none' }} p={'40px'} flexDirection={'column'} justifyContent={'space-between'} textTransform={'uppercase'} overflow={'hidden'} position={'relative'} fontWeight={'700'} >
          ...
          <Flex className='bg4' display={{ xl: 'flex', lg: 'flex', md: 'none', sm: 'none' }} p={'40px'} flexDirection={'column'} justifyContent={'space-between'} textTransform={'uppercase'} overflow={'hidden'} position={'relative'} fontWeight={'700'} >
            <Text>щелкунчик</Text>
      ...
      <Box className='rating' w={{ xl: '1110px', lg: '1110px', md: '100%', sm: '100%' }} h={'550px'} padding={{ xl: '0px', lg: '0px', md: '0px', sm: '60px' }} margin={'0px auto'} marginBottom={'150px'} display={'flex'} alignItems={'center'} justifyContent={'center'}>
        <Box w={'750px'} h={'300px'} display={'flex'} flexDirection={'column'} color={'#D1A954'} fontWeight={'700'}>
          ...
          <Flex gap={'130px'} alignItems={'center'}>
            ...
            <Text fontSize={{ xl: '34px', lg: '34px', md: '34px', sm: '29px' }} color={'white'}>Лучший театр</Text>
          </Flex>
          <Flex gap={'130px'} alignItems={'center'}>
            <Text fontSize={'70px'}>2020</Text>
            <Text fontSize={{ xl: '34px', lg: '34px', md: '34px', sm: '29px' }} color={'white'}>по мнению театральных критиков Парижа</Text>
          </Flex>
        </Box>
      </Box>
    </div>
